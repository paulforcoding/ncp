...
func TestIntegration_OBSToRemote_Copy(t *testing.T) {
	env := requireOBS(t)
	srcPrefix := newOBSPrefix(t, env, "obs2remote-copy-src")
	serveDir := t.TempDir()
...
func TestIntegration_OBSToRemote_Copy_Resume(t *testing.T) {
	env := requireOBS(t)
	srcPrefix := newOBSPrefix(t, env, "obs2remote-copy-r-src")
	serveDir := t.TempDir()
...
func TestIntegration_OBSToRemote_Cksum(t *testing.T) {
	env := requireOBS(t)
	srcPrefix := newOBSPrefix(t, env, "obs2remote-cksum-src")
	serveDir := t.TempDir()
...
func TestIntegration_OBSToRemote_Cksum_Resume(t *testing.T) {
	env := requireOBS(t)
	srcPrefix := newOBSPrefix(t, env, "obs2remote-cksum-r-src")
	serveDir := t.TempDir()
