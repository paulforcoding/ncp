...
func TestIntegration_OSSToOBS_Copy(t *testing.T) {
	envOSS := requireOSS(t)
	envOBS := requireOBS(t)

	srcPrefix := newOSSPrefix(t, envOSS, "oss2obs-copy-src")
	dstPrefix := newOBSPrefix(t, envOBS, "oss2obs-copy-dst")
...
func TestIntegration_OSSToOBS_Copy_Resume(t *testing.T) {
	envOSS := requireOSS(t)
	envOBS := requireOBS(t)

	srcPrefix := newOSSPrefix(t, envOSS, "oss2obs-copy-r-src")
	dstPrefix := newOBSPrefix(t, envOBS, "oss2obs-copy-r-dst")
...
func TestIntegration_OSSToOBS_Cksum(t *testing.T) {
	envOSS := requireOSS(t)
	envOBS := requireOBS(t)

	srcPrefix := newOSSPrefix(t, envOSS, "oss2obs-cksum-src")
	dstPrefix := newOBSPrefix(t, envOBS, "oss2obs-cksum-dst")
...
func TestIntegration_OSSToOBS_Cksum_Resume(t *testing.T) {
	envOSS := requireOSS(t)
	envOBS := requireOBS(t)

	srcPrefix := newOSSPrefix(t, envOSS, "oss2obs-cksum-r-src")
	dstPrefix := newOBSPrefix(t, envOBS, "oss2obs-cksum-r-dst")
